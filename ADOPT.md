...
2. WRITE CLAUDE.md at the repo root from CLAUDE.md.template (create it if absent; if it
...
3. SHOW ME THE DIFF to CLAUDE.md before committing it. List every placeholder you filled and
...
4. AFTER MY GO: commit it (message in this repo's existing style — read the last ten commit
...
5. END WITH "NEEDS YOU": a numbered list of anything still on me. If nothing, "Needs you: nothing."
```
